#temp_info = information gain, s_point = split point, sp = list of split points, 
# self.data[:,i] = 1 col of data, self.labels = classifications of col
#return the info and a split point where info is maximized
